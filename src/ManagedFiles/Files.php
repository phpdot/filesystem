...
final class Files
{
    ...
    public function delete(string $id): FileRecord
    {
        ...
        // Move first, then persist the record pointing at the new location, then
        // flip visibility. A failed move leaves the record intact; a failed
        // setVisibility leaves the record already matching where the bytes are
        // (and the unguessable quarantine key already hides them).
