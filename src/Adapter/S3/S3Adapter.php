...
final class S3Adapter implements AdapterInterface, ChecksumProvider, MultipartCapable, PublicUrlGenerator, TemporaryUrlGenerator
{
    ...
    {
        // S3 has no real directories — they exist implicitly once an object is written under the prefix.
    }

    public function setVisibility(string $path, string $visibility): void
    {
        // Visibility is bucket-policy controlled in v1; per-object ACLs are not managed.
    }
